...
import org.modelmapper.internal.bytebuddy.build.Plugin.Factory.Simple;
...
public class UserServiceImpl implements UserService {
    ...
    public void registUser(UserDTO userDTO) {
        ...
        registUser.setEncryptedPwd(bCryptPasswordEncoder.encode(userDTO.getPwd())); // plain test(평문) -> digest(암호문)
